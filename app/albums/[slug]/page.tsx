        ...
        <div className="max-w-5xl mx-auto">
          ...
          <nav className="mb-8">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <li>
                <Link href={`/artists/${artist.slug}`} className="text-zinc-500 hover:text-white transition-colors">
                  {artist.name}
                </Link>
              </li>
              <li className="text-zinc-600">/</li>
              <li className="text-zinc-400 truncate max-w-[150px]">{album.title}</li>
            </ol>
          </nav>
